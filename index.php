...
<head>
    ...
    <body>
        ...
        <section class="maincontainer">
            ...
            <section class="pagecontainer">
                ...
                <section class="leftcontainer">
                    ...
                    <div class="blogpager">
                        <div class="previous">
                            <a href="blog.php" class="button next-prev">View All</a>
                        </div>
                    </div>
                </section>
                <!-- RIGHT CONTAINER -->
		...
		<button type="button" name="submit" id="submit" data-toggle="modal" data-target="#myModal"  class="button">Go</button>
