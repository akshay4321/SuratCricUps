...
if(isset($_REQUEST['submit1']))
{
 ...
 {
	 $st="insert into totalscoretbl(match_id,team_id,totalrun,over,wicket,inning) values('$matchid','$team2id','$row11[0]','$rowover[0]','$rowwic[0]','$inning2')";
...
while ($row1=mysqli_fetch_array($select1)) 
{
 ...
 <tr id="row1<?php echo $row1['bowl_id'];?>">
  ...
  <td>
   <input type='button' class="edit_button btn btn-info" value="edit" style="display:inline;" id="edit1_button<?php echo $row1['bowl_id'];?>" onclick="edit1_row('<?php echo $row1['bowl_id'];?>');">
