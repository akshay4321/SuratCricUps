...
<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">manage Ground</a></li>
			</ul>

			 			<div class="row-fluid">		
			 			 <div class="span12" align="right"><a href="add-gr.php" title="" data-rel="tooltip" class="btn btn-warning" data-original-title="Add Event">Add Ground</a></div>
						</div>
 					<br/>
         <div class="row-fluid">	
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Manage Ground</h2>
                          ...
                          <?php  while($row=mysqli_fetch_array($result))
                            { ?>		  
                              <tr>  
								...
								<td>
								<a class="btn btn-info" href="edit-gr.php?editid=<?php echo $row[0] ; ?>">
                                 <i class="halflings-icon white edit"></i>  
                                 </a>    
								<a class="btn btn-danger" href="del-gr.php?delid=<?php echo $row[0] ; ?>" >
