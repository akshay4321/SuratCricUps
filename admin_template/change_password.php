					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="edit-profile.php"><i class="halflings-icon user"></i> Profile</a></li>
...
Resource id #9 <div id="content" class="span10" style="    position: relative; min-height: 371px; bottom: 20px; right: 0px">
						...
						<form class="form-horizontal" method="post">
						 ...
						 <?php
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="password" class="span6 typeahead" name="oldpassword" id="oldpassword" value="<?php echo $row[3];?>">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="password" class="span6 typeahead" name="newpass" id="newpass">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="password" class="span6 typeahead" name="newpass1" id="newpass1">
							...
							<div class="form-actions">
							  <button type="submit" name="submit" class="btn btn-primary">Save changes</button>
							   ...
							   if(isset($_POST["submit"]))
							   {
								   ...
								   $str1="select * from admintbl where admin_pass='$oldpass'";
								   ...
								   else
								   {
										...
										if($newpass==$newpass1)
										{
											$str2="update admintbl set admin_pass='$newpass' where admin_id='$row[0]'";
  ...
  <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="password" id="password" value="<?php echo $row[3];?>">
