			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li class="active"><a href="result.php"><i class="icon-envelope"></i><span class="hidden-tablet">Result</span></a></li>
                    <li></li>
...
<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">manage result</a></li>
			 			...
			 			<!--<div class="row-fluid">		
			 			 <div class="span12" align="right"><a href="add-group.php" title="" data-rel="tooltip" class="btn btn-warning" data-original-title="Add Group">Add Group</a></div>
						</div>
 					<br/>-->
         <div class="row-fluid">	
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Manage result</h2>
                          ...
                          <?php  while($row=mysqli_fetch_array($result))
                            { ?>			  
                              <tr>  
								...
								<a class="btn btn-danger" href="del-result.php?delid=<?php echo $row[0] ; ?>" >
