...
$match_time=$_REQUEST['matchtime'];
$venue=$_REQUEST['venue'];

$str="insert into matchtbl values ('','$ground_id','$team1_id','$team2_id','$dt','$match_time','$venue')";
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li class="active"><a href="match.php"><i class="icon-th"></i><span class="hidden-tablet">Fixture</span></a></li>
...
<form method="post">
 <div id="content" class="span10">
        ...
        <li>
					...
					<a href="matches.php">Manage Fixture</a>
					<i class="icon-angle-right"></i> 
				</li>
				<li>
					<i class="icon-plus"></i>
			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-plus"></i><span class="break"></span>Add Matches</h2>
                       ...
                       <!--  <input type="hidden" name="tid" value="" />-->
 						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="matchtime" id="matchtime" value="" placeholder="enter match time">
 							  </div>
							</div>
	                        ...
	                        <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="venue" id="venue" value="" placeholder="enter venue">
 							  </div>
							</div>
