...
$g1_id=$_REQUEST['g1id'];
							...
							$str="select * from matchtbl where match_id='$edit_id'";
							...
							if(isset($_REQUEST['submit']))
							{
								...
								$matchtime=$_REQUEST['matchtime'];
								$venue=$_REQUEST['venue'];
							
								$str1="UPDATE `matchtbl` SET `ground_id`='$ground_id', `team1_id`='$team1_id',`team2_id`='$team2_id',`matchdate`='$dt',`matchtime`='$matchtime',`venue`='$venue' WHERE `match_id`='$edit_id'";
			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-plus"></i><span class="break"></span>Edit Match</h2>
 						  ...
 						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" for="teams_group_id">Ground name</label>
								<div class="controls">
								<select name="ground_id" id="ground_id" data-rel="chosen" value="<?php echo $row1['ground_id'] ?>">
								...
								{
									?>
									<option value="<?php   echo $row[0]; ?>"   <?php if($row[0]==$g1_id) {  echo 'selected'; } ?>><?php  echo $row[1]; ?></option>
							...
							<div class="control-group">
							  <label class="control-label" for="teams_group_id">First Team Name</label>
								...
								{
									?>
							<option value="<?php   echo $row[0]; ?>"   <?php if($row[0]==$t1_id) {  echo 'selected'; } ?>><?php  echo $row[1]; ?></option>
							...
							<div class="control-group">
							  <label class="control-label" for="teams_group_id">Second Team Name</label>
								<div class="controls">
								<select name="team2_id" id="team2_id" data-rel="chosen" value="<?php echo $row1['team2_id'] ?>">
								...
								{
									?>
									<option value="<?php   echo $row[0]; ?>"   <?php if($row[0]==$t2_id) {  echo 'selected'; } ?>><?php  echo $row[1]; ?></option>
									<?php } ?>
							...
							<input type='text' name="datetxt" id="datetxt" placeholder="<?php echo $row1['matchdate'] ?>"/><br>               
							...
							<div class="control-group">
							  <label class="control-label" for="fixtime">Match Time</label>
							  <div class="controls">
								<input type="text" name="matchtime" id="matchtime" value="<?php echo $row1['matchtime'] ?>">
 							  </div>
							</div>
							
							<div class="control-group">
							  <label class="control-label" for="fixtime">Venue</label>
							  <div class="controls">
								<input type="text" name="matchtime" id="matchtime" value="<?php echo $row1['venue'] ?>">
 							  </div>
							</div>
