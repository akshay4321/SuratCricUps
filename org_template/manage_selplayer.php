...
$str="select team_id,team_name from teamtbl t,orgtbl o where o.org_id=t.org_id";
					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <?php  while($row=mysqli_fetch_array($result))
                            { ?>			  
                              <tr>  
								<td><a href="dis-selction_of_player.php?disid=<?php echo $row[0] ; ?>"><?php echo $row[1] ; ?></a></td>  
