					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="../home.php"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
...
<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">not selected player list</a></li>
			</ul>
			...
			<div class="row-fluid">	
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Change Password</h2>
						...
						<form class="form-horizontal" method="post">
						 ...
						 <?php
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="password" class="span6 typeahead" name="oldpassword" id="oldpassword">
							...
							<div class="form-actions">
							  <button type="submit" name="submit" class="btn btn-primary">Save changes</button>
							   ...
							   if(isset($_POST["submit"]))
							   {
								   ...
								   $str1="select * from orgtbl where org_password='$oldpass'";
								   ...
								   else
								   {
										...
										if($newpass==$newpass1)
										{
											$str2="update orgtbl set org_password='$newpass' where org_id='$oid'";
