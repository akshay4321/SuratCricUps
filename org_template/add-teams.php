...
$str="insert into teamtbl values ('','$teamname','$caste','$pic')";
			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-plus"></i><span class="break"></span>Add Teams</h2>
                       ...
                       <!--  <input type="hidden" name="tid" value="" />-->
 						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="team_name" id="team_name" value="">
 							  </div>
							</div>
   							<div class="control-group">
