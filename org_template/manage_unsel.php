...
$str="select * from playertbl where status='0'";
			...
			<div class="row-fluid">	
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>not selected player list</h2>
                            ...
                            { ?>			  
                              <tr>  
								...
								<td>
								 ...
								 <a class="btn btn-info" href="add-sel.php?aid=<?php echo $row[0] ; ?>">
