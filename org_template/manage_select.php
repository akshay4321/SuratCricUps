...
$str="select * from playertbl where status='1' ";
...
<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">selected player list</a></li>
			</ul>
			...
			<div class="row-fluid">	
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>selected player list</h2>
