...
$str="select team_id,caste,team_name,logo from teamtbl t,orgtbl o where o.org_id=t.org_id";
...
<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">manage Teams</a></li>
			 			...
			 			<div class="row-fluid">		
			 			 <div class="span12" align="right"><a href="add-teams.php" title="" data-rel="tooltip" class="btn btn-warning" data-original-title="Add Group">Add Teams</a></div>
						</div>
 					<br/>
         <div class="row-fluid">	
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Manage Teams</h2>
                          ...
                          <?php  while($row=mysqli_fetch_array($result))
                            { ?>			  
                              <tr>  
								...
								<td><img src=<?php echo "upload/$row[3]" ?> height="40" width="40" ></td>  

								<td>
								<a class="btn btn-info" href="edit-team.php?editid=<?php echo $row[0] ; ?>">
                                 <i class="halflings-icon white edit"></i>  
                                 </a>    
								<a class="btn btn-danger" href="del-team.php?delid=<?php echo $row[0] ; ?>" >
