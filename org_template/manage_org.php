		...
		<div class="row-fluid"><!-- start: Main Menu -->
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
                  ...
                  <li><a href="manage_unselect.php"><i class="icon-user"></i><span class="hidden-tablet">unselected player</span></a></li>
         ...
         <div class="row-fluid">	
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Manage organization</h2>
                          ...
                          <?php  while($row=mysqli_fetch_array($result))
                            { ?>			  
                              <tr>  
								...
								<td>
								<a class="btn btn-info" href="edit-org.php?editid=<?php echo $row[0] ; ?>">
                                 <i class="halflings-icon white edit"></i>  
                                 </a>    
								<a class="btn btn-danger" href="del-org.php?delid=<?php echo $row[0] ; ?>" >
