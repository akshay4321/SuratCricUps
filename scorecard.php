...
<head>
    ...
    <section id="submenu-container">
        ...
        <section class="maincontainer">
            <!-- PAGE TITLE -->
            <div class="page-title">Full scorecard match</div>
            <!-- PAGE CONTAINER -->
			...
			<?php
				...
				$string1="select DISTINCT bt.batsman,bt.status,bt.runs,bt.balls,bt.4s,bt.6s,bt.sr from scorecardbatting bt where bt.match_id='$mid' and bt.team_id='$row1[0]'";
				$string2="select DISTINCT bo.bowler,bo.over,bo.maiden,bo.runs,bo.wicket,bo.nb,bo.wd,bo.eco from scorecardbowling bo where bo.match_id='$mid' and bo.team_id='$row2[0]'";
				$res1=mysqli_query($con,$string1);
				$res2=mysqli_query($con,$string2);
				/*---------------*/
				
				$str11="select team_id from teamtbl where team_name = '$team2' ";
				$str22="select team_id from teamtbl where team_name = '$team1' ";
				$result11=mysqli_query($con,$str11);
				$result22=mysqli_query($con,$str22);
				$row11=mysqli_fetch_row($result11);
				$row22=mysqli_fetch_row($result22);



				$string11="select DISTINCT bt.batsman,bt.status,bt.runs,bt.balls,bt.4s,bt.6s,bt.sr from scorecardbatting bt where bt.match_id='$mid' and bt.team_id='$row11[0]'";
				$string22="select DISTINCT bo.bowler,bo.over,bo.maiden,bo.runs,bo.wicket,bo.nb,bo.wd,bo.eco from scorecardbowling bo where bo.match_id='$mid' and bo.team_id='$row22[0]'";
				$res11=mysqli_query($con,$string11);
				$res22=mysqli_query($con,$string22);
				...
				<h2 style="color:indigo;">First Inning</h2>
				<h3 style="font-weight:bold"><?php echo $team1; ?>&nbsp; Batting</h3>
				<thead>
				<tr class="danger">
				<th>Batsman</th>
				<th>Status</th>
				...
				<h3 style="font-weight:bold"><?php echo $team2; ?>&nbsp;Bowling</h3>
				...
				<hr>
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				<h2 style="color:indigo;">Second Inning</h2>
				<h3 style="font-weight:bold"><?php echo $team2; ?>&nbsp; Batting</h3>
				<thead>
				<tr class="danger">
				<th>Batsman</th>
				<th>Status</th>
				...
				<?php while($row33=mysqli_fetch_array($res11))
				{?>
				<tbody>
				<tr>
				<td><?php echo $row33[0];?></td>
				<td><?php echo $row33[1];?></td>
				<td><?php echo $row33[2];?></td>
				<td><?php echo $row33[3];?></td>
				<td><?php echo $row33[4];?></td>
				<td><?php echo $row33[5];?></td>
				<td><?php echo $row33[6];?></td>
				...
				<h3 style="font-weight:bold"><?php echo $team1; ?>&nbsp;Bowling</h3>
				...
				<?php while($row44=mysqli_fetch_array($res22))
				{?>
				<tbody>
				<tr>
				<td><?php echo $row44[0];?></td>
